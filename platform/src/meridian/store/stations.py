...
The read that pass generation and the scheduler use is
``meridian.store.receiving_stations``', kept apart because it answers a different
question for a different caller and carries a rule of its own about coordinate
precision.
"""
